...
defined('JS_PATH') 		? null : define('JS_PATH', SITE_HTTP."public/js/");
defined('CSS_PATH') 	? null : define('CSS_PATH', SITE_HTTP."public/css/");
defined('HEAD_PATH') 	? null : define('HEAD_PATH', SITE_ROOT."public/layout/");
defined('IMG_PATH') 	? null : define("IMG_PATH", SITE_HTTP.'public/img/');
